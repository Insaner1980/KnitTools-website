...
Three options: ignore it (for small mistakes on a scarf, honestly fine), rip back to the error and re-knit, or embrace imperfection. First projects are for learning.

**What should I knit after a scarf?**
A dishcloth (same skills, different shape, introduces following a simple pattern) or a hat (introduces knitting in the round and basic decreases). Both build on what you've learned.
