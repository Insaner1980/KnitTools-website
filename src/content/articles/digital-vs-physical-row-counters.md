...
The [KnitTools app](/) combines tap counting with undo, row reminders, multiple counters per project, voice commands, and session tracking. Available for Android, works entirely offline.
