---
title: "Wie viel Garn brauche ich?"
description: "Schätze den Garnbedarf für Schals, Pullover, Decken und mehr. Mit Projektgrößen, Garnstärken, Maschenprobe und Restgarn."
...
## Schnelle Garnmengen nach Projektart

Manchmal brauchst du vor dem Einkauf nur eine grobe Größenordnung. Keine exakte Rechnung. Nur ein Gefühl für die Menge.
...
Dünneres Garn bedeutet mehr Maschen auf 10 cm. Mehr Maschen auf derselben Breite bedeuten mehr Maschen insgesamt. Mehr Maschen bedeuten meistens mehr Meter. Bis hierhin ist das geradlinig.
...
Die genaueste Schätzung beginnt mit einer echten Maschenprobe.

Die Maschenprobe sagt dir, wie viele Maschen und Reihen in eine bestimmte Strecke passen. Die Projektmaße sagen dir, wie viel Fläche du strickst. Zusammen kommst du viel näher an die tatsächliche Maschenzahl als mit jeder Pauschalregel.

So sieht das praktisch aus: Deine Maschenprobe ergibt 18 Maschen und 24 Reihen auf 10 cm. Das Vorderteil eines Pullovers ist 50 cm breit und 62,5 cm lang. Das sind 90 Maschen in der Breite und 150 Reihen in der Höhe. Multipliziert ergibt das 13.500 Maschen allein für das Vorderteil. Wenn du weißt oder schätzt, wie viel Garn eine Masche verbraucht, wird der Gesamtbedarf zu einer Rechnung statt zu einer Vermutung.

Das musst du nicht von Hand rechnen. Der [Garnbedarfsrechner](/de/werkzeuge/garnbedarfsrechner/) übernimmt die Schätzung und verliert weniger leicht den Überblick als eine Notiz am Rand eines Hefts.
...
Du brauchst zwei Zahlen von der Banderole: Gesamtgewicht und Gesamtlänge. Wenn ein volles 100-g-Knäuel 200 m enthält und der Rest 63 g wiegt, sind etwa 126 m übrig. Teile das Restgewicht durch das volle Gewicht und multipliziere mit der Gesamtlänge.
...
Für Garnreste aus früheren Projekten ist diese Methode ebenfalls nützlich. Mützen, Fäustlinge, Streifen, Kontrastfarben. Alles gute Kandidaten für Restgarn. Knäuel wiegen, Meter berechnen, Einsatz prüfen.

## Was zusätzlich Garn frisst
...
Rippenmuster zieht den Stoff zusammen. Dichte Strukturmuster erhöhen ebenfalls den Verbrauch pro Zentimeter Breite. Wenn das ganze Projekt gerippt oder stark strukturiert ist, unterschätzt eine glatt-rechts-Schätzung den Bedarf.

**Long-Tail-Anschlag** braucht mehr Fadenende, als du denkst. Besonders bei großen Anschlägen mit über 200 Maschen kann der Anschlagsfaden überraschend viel Garn verbrauchen. Wenn er mitten im Anschlag ausgeht, fängst du neu an.

Nähte brauchen auch Garn. Nicht riesig viel, aber leicht zu vergessen.

## Die Regel: ein Knäuel extra

Kauf ein zusätzliches Knäuel, wenn das Garn verfügbar ist und das Budget es zulässt. Das ist die Regel.

Schätzungen kommen nah heran. Hellsehen können sie nicht. Ein Extraknäuel ist eine günstige Absicherung verglichen mit ein paar fehlenden Metern am Ende eines Projekts. Viele Läden nehmen ungeöffnete Knäuel innerhalb eines vernünftigen Zeitraums zurück. Wenn nicht, ist ein Reserveknäuel immer noch nützlicher als ein Projekt, das wegen eines halben Ärmels stehen bleibt.

Das ist noch wichtiger bei handgefärbtem Garn, kleinen Partien oder Garnen, die aus dem Sortiment gehen. Später ein passendes Knäuel zu finden, kann unmöglich sein.

## Nach Anleitung schätzen oder selbst planen

Veröffentlichte Anleitungen geben den Garnbedarf an. Fang dort an. Diese Zahl ist meistens die beste Basis, besonders wenn die Anleitung Fertigmaße und Maschenprobe klar nennt.

Trotzdem hat der angegebene Bedarf Grenzen. Er setzt voraus, dass du genau die genannte Größe strickst, ein ähnlich aufgebautes Garn nutzt und die Maschenprobe der Anleitung erreichst. Änderst du eines davon, verschiebt sich die Zahl.

Entwirfst du selbst oder änderst du viel, ist der Bedarf aus der Anleitung nicht mehr zuverlässig. Mehr Länge am Körper, größere Größen, andere Muster oder ein Wechsel zu einer anderen Garnstärke verschieben die Gesamtmenge. 7-8 cm zusätzliche Körperlänge an einem Worsted-Pullover können leicht 90-180 m zusätzlich brauchen.

Wenn du [Garn ersetzt](/de/artikel/garn-in-einer-strickanleitung-ersetzen/), gleiche die Gesamtmeter ab, nicht die Knäuelzahl. Eine Anleitung mit "8 Knäuel" hilft nur, wenn du dasselbe Garn verwendest. Nutzt du ein Garn mit anderer Lauflänge pro Knäuel, wird die Knäuelzahl bedeutungslos. Gleiche die Meter ab. Prüfe danach, ob die Garnstärke nah genug ist, und [strick eine Maschenprobe](/de/artikel/maschenprobe-messen/).

Hier verdient der [Garnbedarfsrechner](/de/werkzeuge/garnbedarfsrechner/) seinen Platz, egal ob du die Zahl aus einer Anleitung mit deiner Maschenprobe gegenprüfst oder eine Schätzung von null aufbaust.

## FAQ

**Kann ich den Garnbedarf ohne Maschenprobe schätzen?**
...
**Kann ich Garnreste aus verschiedenen Projekten kombinieren?**
Ja, wenn Garnstärke und Pflegehinweise zusammenpassen. Wiege jeden Rest, damit du weißt, womit du arbeitest.
