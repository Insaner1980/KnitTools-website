---
title: "Mehrere Strickprojekte organisieren"
description: "So verwaltest du mehrere Strickprojekte gleichzeitig, ohne Nadeln, Garn oder deine Stelle in der Anleitung zu verlieren."
...
## Was du beim Wiederaufnehmen wissen musst
...
Ein Beutel pro Projekt. Das ist das ganze System. Projekt, Nadeln, Anleitung, restliches Garn und Notizen wohnen zusammen. Wenn du wechselst, nimmst du einen anderen Beutel. Nichts vermischt sich.

Der Behälter ist nicht entscheidend. Reißverschlusstäschchen, Zugbeutel, Ziplock für kleine Projekte. Wichtig ist, dass jedes Projekt eine eigene Einheit ist.
...
Mehrere WIPs werden stressig, wenn du dich wegen der unberührten Projekte schuldig fühlst. Ein paar Ansätze helfen:

**Ein Hauptprojekt, ein tragbares, ein gedankenloses.** Drei aktive Kategorien halten die Menge überschaubar und geben trotzdem Auswahl. Das Hauptprojekt bekommt konzentrierte Zeit. Das tragbare Projekt reist mit. Das gedankenlose Projekt füllt Zeiten, in denen du stricken, aber nicht denken willst. Alles andere ist Warteschlange, nicht aktiv.
...
Ein WIP ist ein Projekt, zu dem du zurückkehren willst. Ein UFO ist ein Projekt, das du aufgegeben hast, ohne es dir einzugestehen.

Anzeichen: Du weißt nicht mehr, welche Größe du gestrickt hast. Die Anleitung ist weg oder die richtige Seite nicht auffindbar. Das Garn wurde teilweise für etwas anderes geplündert. Die Saison, für die das Stück gedacht war, ist zweimal vorbei.

Projekte aufzugeben ist erlaubt. Ribble sie auf, hol Garn und Nadeln zurück und nimm sie von der aktiven Liste. Fünf Projekte mit klarer Absicht sind leichter zu handhaben als fünf Projekte plus drei schuldgefühlsbeladene Altlasten hinten im Schrank.

## Garn über Projekte hinweg verfolgen

Wenn mehrere Projekte laufen, verheddert sich die Garnlogistik. Welche Projekte nutzen dieselbe Garnstärke? Reicht der Rest auf dem Knäuel für die zweite Socke? Hast du die Kontrastfarbe für die Passe schon gekauft?
...
Mindestens: ein Beutel pro Projekt. In jedem Beutel eine Notiz oder in einem digitalen Tracker die aktuelle Reihenzahl und Änderungen. Irgendwo eine Liste aller aktiven Projekte, auf dem Handy, im Notizbuch oder am Whiteboard, damit du das Gesamtbild siehst.

Das reicht, um jedes Projekt ohne Verwirrung wieder aufzunehmen und zu merken, bevor die WIP-Zahl außer Kontrolle gerät.
...
**Wie nehme ich ein Projekt wieder auf, das ich monatelang nicht berührt habe?**
Finde heraus, wo du bist: Reihen zählen, Gestrick lesen, Notizen prüfen. Mit digitalem Tracker zeigen Reihenzahl und Sitzungsverlauf, wann und wo du aufgehört hast. Strick ein paar Reihen langsam, damit Spannung und Muster wiederkommen, bevor du Tempo aufnimmst. Bei komplexer Anleitung lies den relevanten Abschnitt noch einmal, nicht das ganze PDF von vorn.
