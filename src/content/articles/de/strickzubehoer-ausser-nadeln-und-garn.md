...
**App-Zähler** können mehr: mehrere Zähler, Projektzuordnung, Sitzungsverlauf und haptisches Feedback. Die [KnitTools-App](/) enthält einen Reihenzähler fürs Stricken mit Funktionen, die mechanische Zähler nicht bieten können. Der [Vergleich von Strick-Apps](/de/artikel/die-besten-strick-apps-worauf-es-ankommt/) erklärt genauer, worauf es ankommt.
...
**Was gehört in die erste Strickausstattung?** [4,5-5,0-mm-Nadeln aus Bambus oder Holz](/de/artikel/welche-nadelstaerke-fuer-den-einstieg/), gerade, ein Knäuel [Worsted-Garn](/de/artikel/das-beste-garn-fuer-den-einstieg-ins-stricken/), Schere, zwei Wollnadeln und ein paar Maschenmarkierer. Meist unter 20 Euro zusammen. Alles andere kann warten.
