...
category: techniques
categoryOrder: 6
tags: ["rapporter i stickmönster", "asterisk stickmönster", "hakparentes rapport stickning", "läsa rapporter i stickmönster"]
draft: false
lang: sv
translationKey: "knitting-pattern-repeats"
---
Rapporter är hur mönster slipper skriva ut varje maska över ett 200-maskorsvarv. I stället för "2 rm, 2 am, 2 rm, 2 am, 2 rm, 2 am..." tjugofem gånger skriver mönstret "*2 rm, 2 am; upprepa från * varvet ut." Samma resultat, mycket mindre plats.
...
**Enkel:** "*3 rm, 1 am; upprepa från * varvet ut."
...
"5 gånger till" betyder att du arbetar delen en gång först och sedan upprepar den 5 ytterligare gånger, alltså 6 gånger totalt. Det här lurar många. "Upprepa 5 gånger till" = 6 totalt. "Upprepa 5 gånger" kan betyda båda sakerna. De flesta mönster menar 5 totalt, men om maskantalet inte går ihop, prova att läsa det som 5 ytterligare och se om matematiken passar.
...
Vanligt i strukturmönster, randsekvenser och spets. En varvräknare hjälper här. KnitTools [varvräknare](/) följer positionen inom återkommande sektioner, vilket sparar den mentala belastningen av att minnas om du är på varv 3 eller varv 4 i blocket.
