---
title: "Identifier un fil sans étiquette"
description: "Retrouver ce qu'est un fil sans étiquette : tests de fibre, WPI pour l'épaisseur et conseils pour utiliser un fil mystère."
...
## Étape 1 : trouver l'épaisseur avec le WPI

Le WPI est le premier tri le plus rapide.
...
- 12 à 18 tours : fine ou sport (catégorie 2)
- 11 à 15 tours : light ou DK (catégorie 3)
- 9 à 12 tours : medium ou worsted (catégorie 4)
- 6 à 9 tours : bulky (catégorie 5)
- 5 à 6 tours : super bulky (catégorie 6)
- 1 à 4 tours : jumbo (catégorie 7)

Oui, les fourchettes se chevauchent. Le WPI te met dans le bon quartier, pas à l'adresse exacte. Mesure à plusieurs endroits, surtout si le fil est texturé, duveteux ou filé main.

Une fois la fourchette obtenue, le [tableau des épaisseurs de fil](/fr/outils/epaisseurs-de-fil/) est le meilleur endroit pour comparer l'échantillon probable et la taille d'aiguille.

## Étape 2 : identifier la fibre

C'est important pour l'entretien et pour le comportement du tissu. Le [guide des fibres](/fr/articles/fibres-de-fil-laine-coton-acrylique/) couvre chaque type de fibre en détail, mais voici ce qu'il faut observer dans un test maison rapide. Une laine mystère et un acrylique mystère peuvent se ressembler en pelote et se comporter très différemment une fois tricotés et lavés.
...
Moins scientifique, plus instinctif. Manipule le fil et remarque ce qui ressort.

La laine semble souvent élastique et chaude. Le coton est plus frais, moins élastique. L'acrylique peut être plus lisse ou un peu crissant selon la qualité. Le lin commence raide. La soie est lisse et fraîche.

Le toucher seul ne prouve rien. Combiné aux autres tests, il aide à construire l'image.

## Étape 3 : faire un échantillon avant de s'engager

Une fois que tu as une idée de l'épaisseur et de la fibre, tricote un échantillon. C'est la partie qui transforme les indices en quelque chose d'utilisable.

L'échantillon confirme ton estimation d'épaisseur, montre comment le fil se comporte avec ta tension et révèle ce que les tests maison ne peuvent pas dire : dédoublement, gonflant, tombé, boulochage, raideur et apparence après lavage. Si le fil a feutré même un peu au test de l'eau, traite-le comme un fil lavage main et planifie en conséquence.

## Utiliser un fil mystère en pratique

Certains projets tolèrent mieux l'incertitude que d'autres.

Écharpes, cols, couvertures, lavettes, coussins. Tous sont de bons choix pour un fil que tu ne peux pas identifier complètement. Les vêtements ajustés, chaussettes et tout ce où l'élasticité, la reprise de forme ou le lavage comptent vraiment sont plus risqués.

Le problème d'entretien est réel. Sans étiquette, tu devines d'après le comportement. En cas de doute, lave doucement à l'eau fraîche et sèche à plat jusqu'à ce que le fil prouve qu'il supporte davantage.

Si tu prévois d'utiliser beaucoup de fil mystère dans un même projet, teste aussi la tenue de la couleur. Fais tremper un morceau et tamponne-le sur un tissu blanc. Si la couleur transfère, cela change ton plan de lavage.
...
**Puis-je envoyer un fil à un laboratoire pour identifier la fibre ?**  
