---
title: "Quand l'échantillon ne correspond pas"
description: "Ton échantillon ne correspond pas au modèle : comment diagnostiquer le problème, changer d'aiguilles, juger le tissu et savoir quand l'ignorer."
...
## D'abord : vérifie la mesure de ton échantillon

Avant de changer quoi que ce soit, élimine l'erreur de mesure. Pose l'échantillon à plat sur une surface dure, sans l'étirer. Place la règle au centre, pas près du bord de montage ou du bord rabattu où les mailles se comportent différemment.
...
Moins de mailles signifie des mailles plus grandes. La pièce finie sera plus grande.

**Descends d'une taille d'aiguille.** De 4 mm à 3,75 mm, par exemple, puis retricote un échantillon. Si descendre d'une taille entière corrige trop et que ton échantillon idéal se situe entre deux tailles, certaines marques proposent des tailles intermédiaires. Cela vaut la peine de vérifier. Le [tableau des tailles d'aiguilles](/fr/outils/tailles-aiguilles/) montre les tailles disponibles selon les systèmes.
...
Parfois, les chiffres correspondent mais le tissu ne va pas. Trop raide, trop mou, des trous entre les mailles là où tu n'en veux pas. Les nombres sont bons. Le tissu ne l'est pas.

C'est souvent que le fil ne convient pas bien au modèle, même si la catégorie d'épaisseur est la même. Un worsted dense et très retordu et un worsted gonflant et peu retordu peuvent tous deux donner 20 mailles sur 10 cm avec des aiguilles différentes, mais produire des tissus très différents. Le coton donne souvent un tissu plus dense et plus plat. La laine gonfle et remplit les espaces. L'acrylique tombe autrement que les deux.
...
La séquence pour la plupart des problèmes d'échantillon :

Mesure soigneusement ton échantillon, en comptant les demi-mailles. Si l'écart est important, change de taille d'aiguille. Plus grand si tu tricotes trop serré, plus petit si tu tricotes trop lâche. Retricote un échantillon. Mesure à nouveau.

Si tu as changé d'aiguilles deux fois et que tu n'arrives toujours pas à l'échantillon du modèle, vérifie si ton fil est vraiment dans la même catégorie que celui demandé. "DK" chez une marque ne correspond pas toujours à "DK" chez une autre. Compare le métrage pour 100 g sur ton étiquette avec le fil recommandé dans le modèle. Si les chiffres sont très différents, les problèmes d'échantillon suivent.
