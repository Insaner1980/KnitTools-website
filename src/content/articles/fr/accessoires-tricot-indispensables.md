---
title: "Accessoires tricot indispensables"
description: "Guide pratique des accessoires tricot : marqueurs, aiguilles à laine, compteurs de rangs, matériel de blocage et ce qui sert vraiment."
...
Achète un lot avec plusieurs tailles. Les plus petites pour le fingering et le sport, les plus grandes pour le worsted et le bulky. Un lot de 5 ou 6 coûte quelques euros et dure des années.
...
**Les marqueurs ouvrables** (petites épingles de sûreté) s'accrochent à une maille précise. Ils servent à marquer une maille à retrouver plus tard, ou à se fixer dans le tissu pour compter les rangs.

N'importe quoi qui tient sur l'aiguille peut dépanner : une boucle de fil contrastant, un trombone, un élastique. Les marqueurs faits main vendus sur Etsy sont jolis, mais fonctionnellement identiques à un bout de fil.
...
**Les compteurs mécaniques** (barillets à molette sur l'aiguille) sont peu chers et n'ont pas besoin de piles. Mais ils ne comptent que dans un sens, et un choc peut changer le nombre.

**Les compteurs d'application** font plus : plusieurs compteurs, lien avec les projets, historique des sessions, retour haptique. L'[application KnitTools](/) inclut un compteur de rangs pensé pour le tricot, avec des fonctions qu'un compteur mécanique ne peut pas avoir. La [comparaison des applications tricot](/fr/articles/meilleures-applications-tricot/) explique en détail quoi regarder.
...
La plupart indiquent les tailles métriques avec des équivalences, parfois avec une règle pour mesurer l'échantillon. Cela coûte quelques euros et élimine la question "4 mm ou 4,5 mm ?".
...
Achète-la quand tu es prête pour les torsades. Pas avant.

### Matériel de blocage

Pour les finitions, pas pour tricoter lui-même. Mais dès que tu commences à finir proprement, cela devient essentiel.

Tapis de blocage (dalles en mousse emboîtables ; les tapis de jeu pour enfants fonctionnent très bien et coûtent moins cher que les "tapis de blocage tricot" qui sont souvent le même produit). Épingles en T inoxydables ou peignes de blocage. Éventuellement câbles de blocage pour les bords droits de châles. Le [guide du blocage](/fr/articles/bloquer-un-tricot/) explique les méthodes et quand chacune compte.
...
Environ 25 à 60 € pour un ensemble. Utile si tu achètes souvent des écheveaux. Inutile pour les pelotes déjà prêtes.
...
Grands accessoires en forme d'épingle de sûreté. Ils maintiennent des mailles en attente, par exemple des mailles d'encolure ou un pouce de moufle. Un fil contrastant passé dans les mailles fait le même travail. Les arrêts de mailles sont plus rapides et moins agaçants.
...
Que doit contenir un premier kit tricot ? Des [aiguilles droites en bambou 5 mm](/fr/articles/taille-aiguilles-pour-debuter/), une pelote de [fil worsted](/fr/articles/meilleur-fil-pour-debuter-le-tricot/), des ciseaux, deux aiguilles à laine, quelques marqueurs. Moins de 20 € au total. Tout le reste peut attendre.

Les outils chers valent-ils le coup ? Pour les aiguilles, oui si tu tricotes régulièrement. Meilleurs raccords, pointes plus agréables, durée de vie plus longue. Pour les accessoires (marqueurs, arrêts, ciseaux), rarement. Un lot de marqueurs à 2 € fonctionne aussi bien qu'un lot artisanal à 15 €.

Où acheter ? Boutiques de laine locales pour les conseils et pour toucher le fil avant d'acheter. Chaînes de loisirs créatifs pour les bases abordables et le choix large. En ligne pour des marques et tailles précises que tu ne trouves pas près de chez toi.
