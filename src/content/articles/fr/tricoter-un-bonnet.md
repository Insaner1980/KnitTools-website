---
title: "Tricoter un bonnet : méthodes selon ton niveau"
description: "Apprends à tricoter un bonnet en rond par le bas ou à plat avec couture. Taille, diminutions du sommet et choix du fil."
...
Monte les mailles, tricote les côtes, tricote le corps, diminue sur les rangs endroit, rabats quand il reste quelques mailles, puis couds avec le [point de matelas](/fr/articles/assembler-des-pieces-tricotees/).
...
Le [calculateur de mailles à monter](/fr/outils/calculateur-mailles-a-monter/) de KnitTools fait ce calcul à partir de ton échantillon et de ton tour.
...
Et si le bonnet est trop grand ? La solution la plus simple sur un bonnet fini : passer un élastique à l'intérieur du bord. Pour la prochaine fois, [fais un échantillon plus soigneux](/fr/articles/mesurer-un-echantillon-tricot/) ou choisis une taille en dessous. Un bonnet un peu petit s'étire. Trop grand, il glisse.
