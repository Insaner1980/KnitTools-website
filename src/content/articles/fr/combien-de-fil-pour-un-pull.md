...
Oui, mais le métrage change beaucoup. Passer du worsted au DK augmente la quantité totale d'environ 30 à 40 %, même si le fil est plus fin, parce qu'il y a plus de mailles dans toutes les directions. Le guide pour [remplacer un fil dans un modèle](/fr/articles/remplacer-un-fil-dans-un-modele/) explique le processus complet.
