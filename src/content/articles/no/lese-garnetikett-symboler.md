---
title: "Slik leser du en garnetikett"
description: "Forstå garnetiketter: fiberinnhold, garntykkelse, strikkefasthet, vaskeanvisning, fargeparti og hva symbolene betyr."
...
Dette er delen som ser ut som hieroglyfer til du lærer systemet. Ikonene følger den internasjonale merkestandarden for tekstilpleie, den samme som klær bruker. Hvert symbol dekker én type stell: vask, bleking, tørking, stryking og profesjonell rens.

**Vask** får vaskebaljeikonet. Et tall inni er høyeste temperatur i Celsius. En hånd ned i baljen betyr håndvask. Linjer under baljen betyr skånsommere maskinprogram, flere linjer betyr mildere behandling.

En X over vaskebaljen betyr ikke vask i det hele tatt, sjeldent på garn, men det finnes på noen spesialfibre.

**Bleking** er trekanten. En åpen trekant betyr at bleking er tillatt. To diagonale linjer inni begrenser til oksygenblekemiddel uten klor. En X over trekanten: ingen bleking.

De fleste strikkere bruker sjelden blekemiddel. Men lager du noe hvitt eller veldig lyst, betyr det noe om fiberen tåler det.

**Tørking** bruker en firkant. En sirkel inni firkanten betyr at trommeltørking er tillatt. Prikker i sirkelen viser varme: én prikk lav, to normal. En vannrett linje i firkanten betyr tørkes flatt, som er slik de fleste strikkede plagg bør tørke uansett. En loddrett linje betyr heng- eller snortørking.
...
Symbolene er ikke forslag. Håndvask-ull tover hvis den havner i vanlig maskinprogram med varmt vann og bevegelse. En fiber som ikke tåler varme, kommer ut av en varm tørketrommel som et annet objekt enn det som gikk inn.

## Fargeparti og fargenummer

Her blir folk tatt. To ulike tall, to ulike formål, og å blande dem kan gi en synlig stripe over genseren der du byttet nøste.

**Fargenummeret** eller fargenavnet identifiserer nyansen. "Color 412" eller "Dusty Rose." Dette er det samme fra parti til parti. Det er slik du finner samme farge neste år.

**Fargepartinummeret** identifiserer den konkrete innfargingen. To nøster med samme fargenummer, men ulikt fargeparti, kan se identiske ut i butikken og litt ulike når de strikkes ved siden av hverandre. Noen ganger er forskjellen usynlig til du allerede har strikket ti pinner etter nøstebytte.
...
Merkenavn, garnlinje, opprinnelsesland. Nyttig hvis du trenger mer senere, eller hvis du vil huske hva som fungerte.

## Hva etiketten ikke forteller

Etiketten dekker mye. Men den utelater ting som betyr noe.

Den sier ikke hvordan garnet ser ut når det er strikket. Et rolig, ensfarget nøste kan gi nydelig stoff. Et dramatisk håndfarget nøste kan poole i flekker. Umulig å vite fra banderolen alene.

Ingenting om slitestyrke heller. Hvor mye garnet nupper, om det mykner eller hardner i vask, hvordan det tåler en vinter med daglig bruk. De svarene kommer fra erfaring og anmeldelser, ikke etiketter.
