---
title: "Kun neuletiheys ei täsmää ohjeeseen"
description: "Mallitilkun neuletiheys ei täsmää ohjeeseen? Näin selvität syyn ja korjaat tilanteen puikkokoon, neulepinnan ja projektin mukaan."
publishDate: 2026-05-01
category: gauge-calculations
categoryOrder: 3
tags: ["neuletiheys ei täsmää", "neuletiheyden säätö", "neulelaskuri", "mallitilkku", "ohjeen neuletiheys", "silmukkaa tuumalla", "mallitilkun mittaus"]
lang: fi
...
## Tarkista ensin mallitilkun mittaus

Ennen kuin muutat mitään, sulje pois mittausvirhe. Levitä mallitilkku tasaiselle kovalle alustalle venyttämättä. Aseta viivain keskelle, ei luomis- tai päättelyreunan lähelle.
...
## Liikaa silmukoita sentillä: neulot tiukasti
...
## Liian vähän silmukoita sentillä: neulot löysästi

Jos silmukoita on vähemmän, silmukat ovat suurempia. Valmiista kappaleesta tulee isompi.

**Vaihda pienempään puikkokokoon.** Esimerkiksi 4,0 mm puikoista 3,75 mm puikkoihin, ja uusi mallitilkku. Jos täysi koko hyppää ohi ja ihannelukema jäisi kahden koon väliin, joillakin valmistajilla on välikokoja. [Puikkokokotaulukko](/fi/tyokalut/puikkokoot/) näyttää koot eri järjestelmissä.

## Kerrostiheys: se jonka moni ohittaa

Ohjeet ilmoittavat yleensä myös kerrostiheyden eli pystysuuntaisen lukeman. Moni jättää sen huomiotta. Usein se on ihan ok, koska ohje sanoo "neulo kunnes kappale on X cm" eikä "neulo X kerrosta".
...
Joskus saat numerot täsmäämään, mutta kangas tuntuu väärältä. Liian jäykältä, liian lerpulta tai liian harvalta. Numerot ovat oikein. Neulepinta ei ole.

Tämä tarkoittaa yleensä, ettei lanka sovi ohjeeseen, vaikka lankavahvuus olisi sama. Tiivis, vahvasti kerrattu worsted ja ilmava löyhäkierteinen worsted voivat molemmat osua 20 silmukkaan 10 cm matkalla eri puikoilla ja tuottaa silti hyvin erilaisen kankaan. Puuvilla tekee usein tiiviimmän ja litteämmän pinnan. Villa pöyhistyy ja täyttää aukkoja. Akryyli laskeutuu eri tavalla kuin kumpikaan.

Jos oikeassa neuletiheydessä kangas on väärä, vaihtoehdot ovat kokeilla toista lankaa, joka muistuttaa paremmin alkuperäistä kuitua, tai hyväksyä, ettei tämä lanka ja ohje sovi yhteen. Kaikki langat eivät sovi kaikkiin ohjeisiin, vaikka matematiikka antaisi luvan. [Langan korvaamisen opas](/fi/artikkelit/langan-korvaaminen-neuleohjeessa/) käsittelee tätä kuitupuolta tarkemmin.
...
Asusteissa, joissa ei ole tarkkaa istuvuutta, kuten hartiahuiveissa, kaulureissa ja peitoissa, lähellä on usein tarpeeksi. Tee mallitilkku varmistaaksesi, että kangas tuntuu hyvältä, mutta tarkan silmukkaluvun jahtaaminen kolmella mallitilkulla ei aina ole tarpeen.
...
Neuletiheys on 4,5 silmukkaa tuumalla. Ohje haluaa 5. Tarpeeksi lähellä?

10 cm matkalla se on 18 silmukkaa 20 sijaan. 40 tuuman paidassa se voi tarkoittaa noin neljää tuumaa ylimääräistä leveyttä. Ei kovin huomaamatonta.

Puoli silmukkaa tuumaa kohti on raja, jossa useimpien kannattaa kokeilla toista puikkokokoa. Sitä pienempi ero, esimerkiksi neljäsosasilmukka, harvoin merkitsee paljon, ellei projekti ole hyvin leveä tai hyvin istuva.

## Näin etenet

Useimmissa neuletiheysongelmissa järjestys on tämä:

Mittaa mallitilkku huolellisesti ja laske puolikkaat. Jos ero on yli puoli silmukkaa tuumaa kohti, vaihda puikkokokoa. Suurempi puikko liian tiukkaan neuleeseen, pienempi liian löysään. Tee uusi mallitilkku. Mittaa uudelleen.
...
**Kuinka lähellä neuletiheyden pitää olla?**
Istuviin vaatteisiin pyri täsmäämään silmukkatiheys tarkasti. Asusteissa neljäsosasilmukan heitto tuumaa kohti on usein hyväksyttävä. Kerrostiheyden toleranssi on yleensä väljempi, koska moni ohje neulotaan mittoihin eikä kerrosmääriin.

**Pitääkö mallitilkku pestä ennen mittaamista?**
Jos valmis työ pestään, kyllä. Jotkut langat muuttavat neuletiheyttä selvästi pesussa. Superwash-villa voi kasvaa pituutta, puuvilla rentoutuu. Neulo tilkku, pese ja viimeistele se kuten valmiin työn, anna kuivua kokonaan ja mittaa vasta sitten. [Mallitilkun vaiheittainen ohje](/articles/gauge-swatch-step-by-step/) käy prosessin läpi.
