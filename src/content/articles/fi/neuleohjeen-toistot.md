...
Toistojen avulla ohjeen ei tarvitse kirjoittaa jokaista silmukkaa auki 200 silmukan kerroksella. Sen sijaan että ohje sanoisi "2 o, 2 n, 2 o, 2 n, 2 o, 2 n..." kaksikymmentäviisi kertaa, se kirjoittaa "_2 o, 2 n; toista _ kerroksen loppuun". Sama lopputulos, paljon vähemmän tilaa.
...
**Yksinkertainen:** "_3 o, 1 n; toista _ kerroksen loppuun."
...
**Ylijäävillä silmukoilla:** "1 o, _2 o, 2 n; toista _ viimeisiin 3 s asti, 3 o."
...
**Lukumäärällä:** "_lk, 2 o yhteen; toista _ vielä 5 kertaa."

"Vielä 5 kertaa" tarkoittaa, että teet jakson ensin kerran ja toistat sen sen jälkeen 5 kertaa lisää, yhteensä 6 kertaa. Tämä kompastuttaa monia. "Toista vielä 5 kertaa" = 6 yhteensä. "Toista 5 kertaa" voi olla epäselvempi. Useimmat ohjeet tarkoittavat 5 kertaa yhteensä, mutta jos silmukkamäärä ei täsmää, lue se myös mahdollisena 5 lisäkertana ja katso sopiiko lasku.
...
**Sekamerkintä:** "2 o, [1 o, 1 n] 3 kertaa, _4 o, 2 n; toista _ viimeisiin 2 s asti, 2 o."
...
"_[1 o, 1 n] 3 kertaa, 2 o yhteen, lk; toista _ kerroksen loppuun."
...
"Kerrokset 1-4: _2 o, 2 n; toista _ kerroksen loppuun.
...
Tätä näkee tekstuuripinnoissa, raitajaksoissa ja pitsissä. Kerroslaskuri auttaa tässä. KnitTools-sovelluksen [Row Counter](/) seuraa sijaintia toistuvissa jaksoissa, jolloin päässä ei tarvitse pitää, oletko nykyisen jakson kerroksella 3 vai 4.
